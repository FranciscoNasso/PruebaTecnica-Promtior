...
function setTyping(isTyping) {
    ...
    if (isTyping) {
        ...
        const bubble = document.createElement("div");
        bubble.classList.add("message-bubble");
        bubble.textContent = "El asistente está escribiendo...";
...
async function sendMessage(text) {
    ...
    try {
        ...
        if (!payload) {
        answerText = "Respuesta vacía del servidor.";
        ...
        setTyping(false);
        errorEl.textContent =
        "Hubo un problema al hablar con el asistente. Revisá la consola o la configuración.";
    } finally {
        isSending = false;
...
appendMessage(
    "bot",
    "Hola, soy el asistente de Promtior. Podés preguntarme por servicios, enfoque de la empresa u otra información basada en su contenido."
);
